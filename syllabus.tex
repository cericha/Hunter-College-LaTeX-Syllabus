...
\input{sections/course_details.tex}
\section*{Course Description}
\input{sections/course_description}
\section*{Prerequisites}
\input{sections/prerequisites}
\section*{Textbook (Optional)}
\input{sections/textbooks} % Specify if any or all textbooks are optionl
\section*{Grading}
\input{sections/grading_statement}
\section*{Goals}
\input{sections/required_statements/senate_requirements/learning_outcomes}
\section*{Attendance}
\input{sections/attendance}
\section*{Academic Integrity}
\input{sections/required_statements/senate_requirements/academic_integrity}
\input{sections/recommended_statements/academic_integrity_ai}
\section*{ADA Statement}
\input{sections/recommended_statements/adastatement}
\section*{Hunter College Policy on Sexual Misconduct}
\input{sections/required_statements/senate_requirements/policy_sexual_misconduct}
\section*{Anti-Bullying and Cyberbullying Policy}
\input{sections/required_statements/cs_department_requirements/bullying.tex}
\section*{Course Schedule}
\input{sections/schedule.tex}
\section*{Syllabus Change Policy}
\input{sections/syllabus_change_policy}
